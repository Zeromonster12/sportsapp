    ...
    <div className="bg-zinc-900 rounded-lg p-8 mb-6">
      <div className="flex items-center gap-6">
        ...
        <div className="w-24 h-24 rounded-full bg-zinc-800 flex items-center justify-center shrink-0">
          <span className="text-3xl font-bold text-white">{teamAbbr}</span>
        </div>
        ...
        <div className="flex-1">
          ...
          {mascot && <p className="text-xl text-zinc-400 mb-3">{mascot}</p>}
        ...
        {(wins != null || losses != null) && (
          <div className="text-center">
            ...
            <div className="text-sm text-zinc-500 mt-1">Bilancia</div>
            {winPct != null && (
